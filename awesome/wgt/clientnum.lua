...
return function()
  local clientnum = wibox.widget {
    ...
    buttons = gears.table.join(awful.button({}, 1, restore(true)), awful.button({}, 3, restore())),
    font = "Ubuntu Mono 9",
  }
  ...
  for _, s in pairs {
    ...
    client.connect_signal(s, update)
  end
  awful.tag.attached_connect_signal(awful.screen.focused(), "property::selected", update)
